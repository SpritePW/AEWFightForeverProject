...
AELSSWheeledVehicle::AELSSWheeledVehicle(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer.SetDefaultSubobjectClass<UELSSWheeledVehicleMovement>(TEXT("MovementComp"))) {
